...
public class CollectionsController : ControllerBase
{
    ...
    /// </summary>
    [HttpPost]
    public async Task<ActionResult<CollectionResponseViewModel>> Schedule(CreateCollectionViewModel dto)
    {
    ...
    /// </summary>
    [HttpGet("{id}")]
    public async Task<ActionResult<CollectionResponseViewModel>> GetById(int id)
    {
    ...
    /// </summary>
    [HttpGet]
    public async Task<ActionResult<IEnumerable<CollectionResponseViewModel>>> ListAll([FromQuery] int page = 1, [FromQuery] int pageSize = 10)
    {
    ...
    /// </summary>
    [HttpPut("{id}")]
    public async Task<ActionResult<CollectionResponseViewModel>> Update(int id, UpdateCollectionViewModel dto)
    {
